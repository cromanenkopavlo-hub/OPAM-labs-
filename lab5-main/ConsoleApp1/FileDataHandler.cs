namespace CoursesConsoleApp_1
{
    ...
    public static class FileDataHandler
    {
        ...
        /// <summary>
        /// Зчитує файл курсів та перетворює його рядки на список об'єктів.
        /// </summary>
        ...
        /// <summary>
        /// Зчитує дані студентів із файлу.
        /// </summary>
        ...
        /// <summary>
        /// Зчитує дані викладачів із файлу.
        /// </summary>
        /// <returns>Список об'єктів викладачів.</returns>
        public static List<Teachers> ReadTeachers()
        {
            List<Teachers> list = new List<Teachers>();
            if (!File.Exists(TeachersPath))
            {
                return list;
            }
        ...
        /// <summary>
        /// Зберігає список студентів у файл CSV.
        /// </summary>
        /// <param name="list">Список студентів.</param>
        public static void SaveStudents(List<Students> list)
        {
            List<string> lines = new List<string> { "Id,Email,PasswordHash" };
            foreach (var s in list)
            {
                lines.Add($"{s.Id},{s.Email},{s.PasswordHash}");
            }
        ...
        /// <summary>
        /// Зберігає список викладачів у файл CSV.
        /// </summary>
        /// <param name="list">Список викладачів.</param>
        public static void SaveTeachers(List<Teachers> list)
        {
            List<string> lines = new List<string> { "Id,Username,PasswordHash" };
            foreach (var t in list)
            {
                lines.Add($"{t.Id},{t.Username},{t.PasswordHash}");
            }
        ...
        /// <summary>
        /// Перевіряє наявність файлу та створює
        /// його з заголовком, якщо він порожній або відсутній.
        /// </summary>
